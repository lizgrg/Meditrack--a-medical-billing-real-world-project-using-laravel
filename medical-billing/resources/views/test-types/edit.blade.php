            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('test-types.update', $testType) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $testType->name) }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" min="0" name="fee" id="fee" value="{{ old('fee', $testType->fee) }}" required
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="inline-flex items-center">
                            ...
                            <span class="ms-2 text-sm text-gray-700">Active (visible when creating new invoices)</span>
                        </label>
                    </div>

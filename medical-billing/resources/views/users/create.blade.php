        ...
        <div class="max-w-xl">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="mb-6">
                        <label for="password" class="block text-sm font-medium text-gray-700">Temporary Password <span class="text-red-500">*</span></label>
                        <input type="text" name="password" id="password" required minlength="8"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500">
                        <p class="mt-1 text-xs text-gray-500">At least 8 characters. Share this with the user securely — they can change it later from their profile.</p>
                    </div>
